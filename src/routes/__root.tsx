...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rinkal Satani — Front-end Developer" },
      { name: "description", content: "Front-end developer with 5+ years building scalable web and mobile apps with React, TypeScript and GraphQL." },
      { name: "author", content: "Rinkal Satani" },
      { property: "og:title", content: "Rinkal Satani — Front-end Developer" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300..700&family=Space+Grotesk:wght@400;500;600;700&display=swap" },
      {
        rel: "stylesheet",
        href: appCss,
      },
